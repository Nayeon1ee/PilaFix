						...
						<form class="row g-3" action="insertCenterTicket.do" method="post"
							...
							<div class="col-md-12">
								<label class="form-label">수강권명</label> <input type="text"
									name="tkName" class="form-control" placeholder="수강권명을 입력하세요">
							</div>
							<div class="col-md-12">
								<label class="form-label">정원</label> <select class="form-select"
									name="tkCapacity" id="tkCapacity"
							...
							<div class="col-md-12">
								<label class="form-label">수강권 사용 가능 횟수</label> <select
									class="form-select" name="tkUsageCount" id="tkUsageCount"
									aria-label="Default select example">
							...
							<div class="col-md-12">
								<label class="form-label">수강권 사용 가능 기간</label> <select
									class="form-select" name="tkUsageNumMonth" id="tkUsageNumMonth"
									aria-label="Default select example">
							...
							<div class="col-md-12">
								<label class="form-label">가격</label> <input type="text"
									name="tkPrice" class="form-control"
									placeholder="가격을 입력하세요(숫자만 입력하세요)">
							</div>
							<div class="col-md-12">
								<label class="form-label">수강권 설명</label>
								<textarea name="tkDescription" class="form-control"
								...
								<fieldset class="row mb-3">
									<div class="col-sm-10">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio"
												name="purchaseAvailableYN" id="flexRadioDefault2" value=true>
											<label class="form-check-label" for="flexRadioDefault2">구매
												가능</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio"
												...
												for="flexRadioDefault2">구매 불가</label>
										</div>
