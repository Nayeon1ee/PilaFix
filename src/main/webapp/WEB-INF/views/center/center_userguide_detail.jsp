			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<form class="row g-3">
							<div class="col-md-4">
								<label class="form-label">정책 번호</label> <input type="text"
									readonly disabled class="form-control"
									value=${userguide.ugCode }>
							</div>
							<div class="col-md-4">
								<label class="form-label">구분</label> <input type="text" readonly
									disabled class="form-control" value="${userguide.ugType }">
							</div>
							<div class="col-md-4">
								<label class="form-label">이용정책 제목</label> <input type="text"
									readonly disabled class="form-control"
									value="${userguide.ugName }">
							</div>
							<div class="col-md-12">
								<label class="form-label">이용정책 내용</label>
								<textarea class="form-control" readonly disabled
									style="height: 300px;">${userguide.ugContent }</textarea>
							</div>
							<div class="col-md-12">
								<label class="form-label">작성일자</label> <input type="text"
									readonly disabled class="form-control"
									value=${userguide.ugRegistrationDate }>
							</div>
							<%--
               <div class="col-md-12">
                  <label class="form-label">공개여부</label>
                   <input type="text" readonly disabled class="form-control" value=${userguide.ugOpenYN ? "공개":"비공개" } >
                </div>
                 --%>
								...
								<div class="btn-toolbar justify-content-end d-flex"
									...
									<div class="me-auto ms-3">
										<button type="button" class="btn btn-secondary"
											onclick="location.href='getUserguideList.do'">취소</button>
									</div>

									<div class="btn-group me-2">
										<button type="button" class="btn btn-primary"
											onclick="location.href='updateUserguide.do?ugCode=${userguide.ugCode }'">수정</button>
									</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary"
					onclick="deleteUserguide(${userguide.ugCode})">삭제</button>
			</div>
		</div>
	</div>
</div>
