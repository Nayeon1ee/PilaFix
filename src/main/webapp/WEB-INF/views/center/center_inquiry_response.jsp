							...
							<form class="row g-3">
								...
								<div class="text-center">
									<button type="submit" class="btn btn-secondary"
										onclick="location.href='center_question_board'">취소</button>
								</div>
								<!-- <div class="row mb-3">
						<div class="col-sm-10" style="float: left; margin-left: 47%;">
						<button type="submit" onclick="location.href='admin_question_board'" class="btn btn-primary" style="background-color: #5C636A;border: #5C636A;">목록</button>
				</div> -->
							</form>
