...
<link
	href="${pageContext.request.contextPath }/resources/css/style_center_notice_board_modify.css"
	rel="stylesheet">
<link
             	 ...
             	 -->
							...
							<form class="row g-3" id="registrationForm000">
								...
								<div class="text-center">
									<button type="button"
										class="btn btn-secondary btn_registration_000"
										id="registrationButton000" onclick="location.href='center_">수정</button>

									<button type="button" class="btn btn-secondary"
										onclick="location.href='center_class_management'">취소</button>
