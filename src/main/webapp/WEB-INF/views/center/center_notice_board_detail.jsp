...
<link
	href="${pageContext.request.contextPath }/resources/css/style_center_notice_board_detail.css"
	rel="stylesheet">
<link
							...
							<form class="row g-3" id="registrationForm000">
								...
								<div class="col-md-12">
									...
									<textarea class="form-control" id="contentInput000"
										style="height: 300px" disabled>등록된 공지사항 내용</textarea>
								</div>
								...
								<div class="text-center">
									<button class="btn btn-secondary btn_registration_000"
										id="registrationButton000" onclick="location href='center_notice_board_modify'">
										수정
									</button>
									<button class="btn btn-secondary" onclick="location href='center_notice_board'">
										취소
									</button>
