				...
				<div class="col-lg-12">
					...
					<form class="row g-3">
					    ...
					    <div class="col-md-6">
					        ...
					        <input type="text" readonly class="form-control" value="${question.qsRegdate}">
					    </div>
					
					    <!-- 수정 일시 -->
					    <div class="col-md-6">
					        <label class="form-label">수정 일시</label>
					        <input type="text" readonly class="form-control" value="${question.qsModifiedDate}">
					    </div>
