...
<link
	href="${pageContext.request.contextPath }/resources/css/style_center_notice_board_register.css"
	rel="stylesheet">
<link
							...
							<form class="row g-3" id="registrationForm000">
								...
								<div class="col-md-12">
									<label class="form-label">제목</label> <input type="text"
										class="form-control" id="titleInput000" value="" />
								</div>
								<div class="col-md-12">
								...
								<div class="text-center">
									<button class="btn btn-secondary btn_registration_000"
										id="registrationButton000">등록</button>
									<button type="button" class="btn btn-secondary" onclick="location.href='center_notice_board'">취소</button>
								</div>
							</form>
