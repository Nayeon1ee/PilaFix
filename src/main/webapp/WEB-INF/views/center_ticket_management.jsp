...
<!-- =======================================================
  ...
  * License: https://PilaFixmade.com/license/
  ======================================================== -->
<link rel="stylesheet"
	href="./resources/css/style_center_ticket_management.css">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="button_con">
								<button type="button"
									onclick="location.href='center_create_ticket'"
									class="btn btn-primary btn-lg">수강권 등록</button>
							</div>
							...
							<table class="table datatable">
								...
								<tbody>
									<tr>
										<th scope="row">TIC123</th>
										<td><a href="center_detail_ticket">[종로점] 6:1 그룹 레슨</a></td>
										<td>그룹(6)</td>
										<td>3개월</td>
										<td>20</td>
										<td>330,000원</td>
									...
									<tr>
										<th scope="row">TIC124</th>
										<td><a href="center_class_management_detail">[강남점]
												3:1 그룹 레슨</a></td>
										<td>그룹(3)</td>
										<td>3개월</td>
										<td>20</td>
									...
									<tr>
										<th scope="row">TIC125</th>
										<td><a href="center_class_management_detail">[종로점] 척뿌
												레슨</a></td>
										<td>개인</td>
										<td>3개월</td>
										<td>30</td>
									...
									<tr>
										<th scope="row">TIC126</th>
										<td><a href="center_class_management_detail">[강남점] 개인
												레슨</a></td>
										<td>개인</td>
										<td>3개월</td>
										<td>20</td>
									...
									<tr>
										<th scope="row">TIC127</th>
										<td><a href="center_class_management_detail">[학익점] 개인
												레슨</a></td>
										<td>개인</td>
										<td>3개월</td>
										<td>10</td>
									...
									<tr>
										<th scope="row">TIC123</th>
										<td><a href="center_class_management_detail">[종로점]
												6:1 그룹 레슨</a></td>
										<td>그룹(6)</td>
										<td>3개월</td>
										<td>20</td>
									...
									<tr>
										<th scope="row">TIC125</th>
										<td><a href="cneter_class_management_detail">[종로점] 척뿌
												레슨</a></td>
										<td>개인</td>
										<td>3개월</td>
										<td>30</td>
