							...
							<form class="row g-3">
								...
								<div class="col-md-12">
									<label class="form-label">약관명</label> <input type="text"
										class="form-control" value="개인정보 수집 및 이용">
								</div>
								<div class="col-md-12">
...
회원가입 시점에 네이버가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
								...
								<fieldset class="row mb-3">
									<div class="col-sm-10">
										<div class="form-check form-check-inline">
											...
											<label class="form-check-label" for="gridRadios1"> 필수
											</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio"
												name="gridRadios" id="gridRadios2" value="option2">
											<label class="form-check-label" for="gridRadios2"> 선택
											</label>
										</div>
									</div>
								</fieldset>
								<div class="text d-flex justify-content-end">
									<button type="reset" class="btn btn-secondary"
										onclick="location.href='admin_terms_detail.do'">목록</button>
