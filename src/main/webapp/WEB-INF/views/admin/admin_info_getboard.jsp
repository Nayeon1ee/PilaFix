             ...
             <p style="magin-top: 1%;"></p>
               ...
               <div class="row mb-6">
					<div class="col-sm-1000">
						<button type="submit" class="btn btn-primary" style="margin-left:2%;" onclick="location.href='admin_info_boardlist'">목록</button>
						<button type="submit" class="btn btn-primary" style="margin-left:78%;" onclick="button_success();">수정</button>
