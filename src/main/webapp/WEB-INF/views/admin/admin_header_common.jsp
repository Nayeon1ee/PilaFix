		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="components-nav" class="nav-content collapse "
					...
					<li><a href="admin_membership.do"> <i class="bi bi-circle"></i><span>회원관리</span>
					</a></li>
					<li><a href="admin_trainer.do"> <i class="bi bi-circle"></i><span>강사관리</span>
					</a></li>
					<li><a href="admin_center_management.do"> <i
							class="bi bi-circle"></i><span>센터관리</span>
					</a></li>
				</ul></li>
			<!-- End 고객관리 Nav -->

			<li class="nav-item"><a class="nav-link collapsed" href="admin_community.do">
					<i class="bi bi-layout-text-window-reverse"></i> <span>커뮤니티
						관리</span>
			</a></li>
			<!-- End 커뮤니티 관리 Nav -->

			<li class="nav-item"><a class="nav-link collapsed" href="admin_report.do">
					<i class="bi bi-dash-circle"></i> <span>신고글 관리</span>
			</a></li>
			<!-- End 신고글 관리 Nav -->

			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#forms-nav" data-bs-toggle="collapse" href="admin_FAQ.do">
				...
				<ul id="forms-nav" class="nav-content collapse "
					...
					<li><a href="admin_FAQ_register.do"> <i class="bi bi-circle"></i><span>FAQ
								등록</span>
					</a></li>
				</ul></li>
			<!-- End FAQ관리 Nav -->
			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#tables-nav" data-bs-toggle="collapse" href="admin_terms.do">
					<i class="bi bi-shield-check"></i><span>이용약관 및 정책관리</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="tables-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="admin_terms.do"> <i class="bi bi-circle"></i><span>전체
								약관 목록 조회</span>
					</a></li>
					<li><a href="admin_terms_register.do"> <i class="bi bi-circle"></i><span>약관
								등록</span>
					</a></li>
				</ul></li>
			<!-- End Tables Nav -->
			...
			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#icons-nav" data-bs-toggle="collapse" href="admin_notice_list.do">
					<i class="bi bi-exclamation-circle"></i><span>공지사항관리</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="icons-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="admin_notice_list.do"> <i class="bi bi-circle"></i><span>전체
								공지사항 목록</span>
					</a></li>
					<li><a href="admin_notice_register.do"> <i class="bi bi-circle"></i><span>공지사항
								등록</span>
					</a></li>
				</ul></li>
			<!-- End Icons Nav -->
			...
			<li class="nav-item"><a class="nav-link collapsed" href="admin_send_email_list.do">
					<i class="bi bi-bell-fill"></i> <span>이메일 발송 이력 관리</span>
			</a></li>
			<!-- End 이메일 발송이력 관리 Nav -->

			<li class="nav-item"><a class="nav-link collapsed" href="admin_send_message_list.do">
