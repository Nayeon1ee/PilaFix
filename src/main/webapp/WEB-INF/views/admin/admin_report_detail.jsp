...
<body>
						...
						<div class="card-body">
							...
							<form class="row g-3" >
								...
								<div class="col-md-5">
									...
									<input type="text" readonly disabled class="form-control" value="작성자를 입력해주세요" placeholder="작성자를 입력해주세요">
								</div>
								<div class="col-md-5">
								...
								<div class="col-md-12">
									<label class="form-label">글 제목</label> <input type="text"
										readonly disabled class="form-control" value="제목을 입력해주세요" placeholder="제목을 입력해주세요">
								</div>
								<div class="col-md-12">
									<label class="form-label">글 내용</label>
									<textarea readonly disabled class="form-control"
										style="height: 300px;" placeholder="글 내용을 입력해주세요"></textarea>
								</div>
										...
										<div class="btn-toolbar justify-content-end d-flex"
											...
											<div class="btn-group me-2">
												<button type="button" class="btn btn-secondary"
													onclick="location.href='getComplaintsInfoList.do'">취소</button>
											</div>
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							onclick="deleteReport(${ComplaintsInfo.cpCode})">확인</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
	function deleteReport(cpCode) {
		fetch('/pilafix/deleteComplaintsInfo.do?cpCode=' + cpCode, {
			method: 'GET'
		})
			.then(response => {
				if (!response.ok) {
				...
				window.location.href = 'getComplaintsInfoList.do'; // 커뮤니티 목록 페이지로 리다이렉트
			})
			.catch(error => {
				console.error(error);
			});
