...
<link href="${pageContext.request.contextPath }/resources/css/style_admin_notice_board_modify.css" rel="stylesheet">
              ...
              <p>웹관리자가 공지사항의 상세내용을 수정할수 있는 페이지입니다.</p>
				...
				<form class="row g-3" id="registrationForm000">
				    ...
				    <div class="col-md-12">
				        ...
				        <input type="text" class="form-control" id="titleInput000" value="등록된 공지사항" >
				    </div>
				    <div class="col-md-12">
				        <label class="form-label">내용</label>
				        <textarea class="form-control" id="contentInput000" style="height: 300px" >등록된 공지사항 내용</textarea>
				    </div>
				...
				<div class="col-sm-10">
				  ...
				  <div class="form-check form-check-inline radiobtn001">
				    ...
				    <div class="text-center">
				        <button class="btn btn-secondary btn_registration_000" id="registrationButton000">수정</button>
