              ...
              <p>웹관리자가 공지사항의 상세내용을 수정할수 있는 페이지입니다.</p>
				...
				<input type="hidden" name="originalOpenYn" id="originalRadioState" value="${originalRadioState}">
				    <div class="col-md-5">
				        ...
				        <input type="text" class="form-control" name="writerMemberCode" value="${adminInfo.writerMemberName }" disabled>
				    </div>
				    <div class="col-md-5">
				    ...
				    <div class="text-center">
				        ...
				        <button type="button" class="btn btn-secondary" onclick="location.href='getAdminInfoList.do'">취소</button>
				    </div>
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  공개글로 수정 시, <b>전체 회원</b>에게 알림이 전송됩니다. <br><br>
                                  수정하시겠습니까?
                              </div>
