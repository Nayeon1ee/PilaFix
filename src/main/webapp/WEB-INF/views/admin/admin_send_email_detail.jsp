...
<head>
  ...
  <link href="${pageContext.request.contextPath }/resources/css/style_admin_send_email_detail.css" rel="stylesheet">
...
17728</textarea>
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-secondary" onclick="location.href='admin_send_email_list.do'">목록</button>
                </div>
