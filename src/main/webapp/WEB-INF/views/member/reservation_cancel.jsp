				...
				<div class="reserv_cancel_list d-flex justify-content-center">
					<div class="section"
						...
						<div class="time" id="cancelTime">
							<p class="lead mb-0">
								취소 가능한 시간까지 <span id="timeRemaining" style="color: #e44d26;"></span>	남았어요!
							</p>
						</div>
					</div>
				...
				<div class="container" style="max-width: 700px">
					...
					<div class="section">
						...
						<div class="d-grid gap-2 justify-content-end me-2">
							<button class="btn btn-primary my-auto" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 100px;">취소하기</button>
						</div>
