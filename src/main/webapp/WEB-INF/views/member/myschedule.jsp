							...
							<div class="card-header-con py-1 mt-1 custom-rounded">
								<div class="btn-group d-flex py-1" role="group"
									...
									<input type="radio" class="btn-check" name="options"
										...
										onclick="changeColor('gray-bar')">전체</label> <input
										type="radio" class="btn-check" name="options" id="option2"
										autocomplete="off"> <label
										class="btn btn-outline-primary2" for="option2"
										onclick="changeColor('blue-bar')">예약</label> <input
										type="radio" class="btn-check" name="options" id="option3"
										autocomplete="off"> <label
										class="btn btn-outline-primary3" for="option3"
										onclick="changeColor('green-bar')">출석</label> <input
										type="radio" class="btn-check" name="options" id="option4"
										autocomplete="off"> <label
										class="btn btn-outline-primary4" for="option4"
										onclick="changeColor('orange-bar')">결석</label>
								</div>
							</div>
