					...
					<div class="payment-history">
						<div class="payment-item">
							...
							<div class="payment-details">
								<div class="payment-description">${paymentInfo.centerName}
									[${paymentInfo.paMethod }결제]</div>
								...
								<div class="d-flex justify-content-between align-items-center">
									<c:choose>
										...
										<c:otherwise>
											...
											<c:set var="expiryDateTime"
												value="${paymentInfo.paDateTime.time + (24*60*60*1000)}" />
											<c:if test="${expiryDateTime gt currentTime}">
											</c:if>
										</c:otherwise>
									</c:choose>

									<div class="payment-description">${paymentInfo.tkCapacity }:1
										${paymentInfo.tkLessonType}레슨 ${paymentInfo.tkUsageCount }회(${paymentInfo.tkUsageNumMonth}개월)</div>

									<button type="button" class="btn btn-sm btn-secondary"
										onclick="cancelPayment('${paymentInfo.paId}','${paymentInfo.tkLessonType}','${paymentInfo.tkUsageCount }')">결제취소</button>
								</div>
								<div class="d-flex justify-content-between align-items-center">
						...
						<div
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>
										<strong>수강권을 사용하셔서 결제취소가 불가합니다.</strong>
									</p>
									<p style="font-size: 14px;">결제 취소를 원하신다면 예약하신 수업을 취소하시고 다시
										진행해주시기 바랍니다.</p>
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-primary"
										onclick="location.href='/pilafix/schedule.do'">내 스케줄로
										이동</button>
								</div>
							</div>
						</div>
					...
					<div class="modal-dialog">
						<div
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>
										서버오류로 결제 취소가 진행되지않았습니다.<br> 다시 진행해주시기 바랍니다.
									</p>
