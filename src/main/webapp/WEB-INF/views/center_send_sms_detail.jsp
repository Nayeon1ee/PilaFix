...
<link
	href="${pageContext.request.contextPath }/resources/css/style_center_send_sms_detail.css"
	rel="stylesheet">
<link
			...
			<div class="row">
				<div class="col-lg-12">
             	 ...
             	 -->
							...
							<form class="row g-3">
								<div class="col-md-3">
									<label class="form-label">수신자명</label> <input type="text"
										readonly class="form-control" value="홍길동" disabled>
								</div>
								<div class="col-md-4">
									<label class="form-label">수신자번호</label> <input type="text"
										readonly class="form-control" value="010-1111-2222" disabled>
								</div>
								<div class="col-md-5">
								...
								<div class="col-md-3">
									<label class="form-label">발송코드</label> <input type="text"
										readonly class="form-control" value="1234" disabled>
								</div>
								<div class="col-md-4">
									<label class="form-label">상태</label> <input type="text"
										readonly class="form-control" value="실패" disabled>
								</div>
								<div class="col-md-5">
									<label class="form-label">비고</label> <input type="text"
										readonly class="form-control" value="전화번호오류" disabled>
								</div>
								<div class="col-md-12">
