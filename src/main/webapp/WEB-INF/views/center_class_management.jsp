...
<title>수업 관리</title>
<link rel="stylesheet"
	href="./resources/css/style_center_class_management.css" />
						...
						<div class="card-body">
							...
							<div class="button_con">
								<button type="button" class="btn btn-primary btn-lg"
									onclick="location.href='center_create_class'">수업 등록</button>
							</div>
							...
							<table class="table datatable">
								...
								<tbody>
									<tr>
										<th scope="row">CLS123</th>
										<td><a href="detail_class">척뿌</a></td>
										<td>주민승</td>
										<td>그룹</td>
										<td>예약한 인원 / 정원</td>
										<td>2023.12.08</td>
									...
									<tr>
										<th scope="row">CLS124</th>
										<td><a href="class_management_detail">척접</a></td>
										<td>이나연</td>
										<td>그룹</td>
										<td>예약한 인원 / 정원</td>
										<td>2023.12.08</td>
									...
									<tr>
										<th scope="row">CLS125</th>
										<td><a href="class_management_detail">척갈</a></td>
										<td>민은주</td>
										<td>개인</td>
										<td>예약한 인원 / 1</td>
										<td>2023.12.09</td>
									...
									<tr>
										<th scope="row">CLS126</th>
										<td><a href="class_management_detail">혼성 - 체어/바렐(B) :
												다이어트, 체력강화</a></td>
										<td>김수미</td>
										<td>그룹</td>
										<td>예약한 인원 / 정원</td>
									...
									<tr>
										<th scope="row">CLS127</th>
										<td><a href="class_management_detail">척뿌</a></td>
										<td>김영우</td>
										<td>개인</td>
										<td>예약한 인원 / 1</td>
										<td>2023.12.10</td>
