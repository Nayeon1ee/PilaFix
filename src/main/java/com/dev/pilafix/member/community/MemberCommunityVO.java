...
public class MemberCommunityVO {
	...
	public String toString() {
		return "MemberCommunityVO [memberCmNumber=" + memberCmNumber + ", memberCmTitle=" + memberCmTitle
				...
				+ memberBlameReasonName + ", memberReNumber=" + memberReNumber + ", memberReTitle=" + memberReTitle
				+ ", memberReContent=" + memberReContent + ", memberWriterRoleCode=" + memberWriterRoleCode
				+ ", memberWriterCode=" + memberWriterCode + ", memberReRegdate=" + memberReRegdate
				+ ", memberReTargetPostType=" + memberReTargetPostType + ", memberReTargetPostNumber="
				+ memberReTargetPostNumber + "]";
	}
